...
import { Upload, X, File, CheckCircle, Clock, AlertCircle, FileSpreadsheet } from 'lucide-react';
      ...
      >
        <div className="flex flex-col items-center gap-4">
          ...
          <button
            ...
            className="mt-1 px-6 py-2.5 bg-primary text-white rounded-lg hover:bg-primary-hover transition-all duration-200 font-medium shadow-lg shadow-primary/25 hover:shadow-primary/40 active:scale-[0.97]"
        ...
        {file.status === 'processing' && (
          <div className="flex items-center gap-3 mt-2">
            <div className="flex-1 h-1.5 bg-border rounded-full overflow-hidden">
              <div
                className="h-full bg-linear-to-r from-primary to-accent rounded-full progress-bar-animated"
